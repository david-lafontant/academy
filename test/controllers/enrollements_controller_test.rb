...
class EnrollementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollement" do
    assert_difference("Enrollement.count") do
      post enrollements_url, params: { enrollement: { course_id: @enrollement.course_id, user_id: @enrollement.user_id } }
    end
  ...
  test "should update enrollement" do
    patch enrollement_url(@enrollement), params: { enrollement: { course_id: @enrollement.course_id, user_id: @enrollement.user_id } }
